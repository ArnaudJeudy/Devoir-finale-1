...
Pour  ce devoir, nous allons utiliser les donnees du fichier des aggregats monetaires de la BRH. 

En premier lieu, nous allons proceder a une manipulation des donnees:

- filtration des colonnes a partir d'Octobre 1990 jusqu'au dernier mois de disponibilite des donnees, i.e. Octobre 2021. 
- Effacer les lignes et colonnes inutiles
- Selectionner quatre variables : l'aggregat monetaire M3, le taux de change, les réserves nettes de changes BRH avec dépôts des BCMs (millions de  dollars US) et les Réserves nettes de change du système bancaire (millions de dollars US)
